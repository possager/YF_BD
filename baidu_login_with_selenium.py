...
def login():
    ...
    with open(basic_file+'baidu_login','w+') as f:
    ...
    element_publish_text.send_keys('hello')
    time.sleep(2)
    publish_button = driver.find_element_by_xpath('//div[@class="poster_component editor_bottom_panel clearfix"]/div[@class="j_floating"]/a')
